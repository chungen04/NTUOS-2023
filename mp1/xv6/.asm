...
void s4(int signo)
{
   ...
   e:	f7650513          	addi	a0,a0,-138 # f80 <thread_kill+0x16>
...
void s3(int signo)
{
  ...
  30:	f6450513          	addi	a0,a0,-156 # f90 <thread_kill+0x26>
...
0000000000000044 <s5>:
{
  ...
  60:	f44a8a93          	addi	s5,s5,-188 # fa0 <thread_kill+0x36>
        if(i == 8) {
  64:	4a21                	li	s4,8
  ...
  7e:	c5c080e7          	jalr	-932(ra) # cd6 <thread_exit>
        thread_yield();
  82:	00001097          	auipc	ra,0x1
  86:	e40080e7          	jalr	-448(ra) # ec2 <thread_yield>
    while(1) {
...
{   
  ...
  ba:	efaa0a13          	addi	s4,s4,-262 # fb0 <thread_kill+0x46>
        i++;
        if(i == 26) {
  ...
  da:	dec080e7          	jalr	-532(ra) # ec2 <thread_yield>
        if(signo) printf("handler 2: %d\n", i*2);
...
void f2(void *arg)
{
 ...
 118:	eac50513          	addi	a0,a0,-340 # fc0 <thread_kill+0x56>
 11c:	00001097          	auipc	ra,0x1
 120:	8de080e7          	jalr	-1826(ra) # 9fa <printf>
 124:	4485                	li	s1,1
 126:	00001a17          	auipc	s4,0x1
 12a:	e9aa0a13          	addi	s4,s4,-358 # fc0 <thread_kill+0x56>
        if (i == 4) {
 12e:	4991                	li	s3,4
 ...
 138:	d8e080e7          	jalr	-626(ra) # ec2 <thread_yield>
        printf("thread 2: %d\n", i++);
 ...
 154:	b86080e7          	jalr	-1146(ra) # cd6 <thread_exit>
...
000000000000015a <f5>:
{
 ...
 178:	dda080e7          	jalr	-550(ra) # f4e <thread_register_handler>
        printf("thread 5: %d\n", i++);
 17c:	45a9                	li	a1,10
 17e:	00001517          	auipc	a0,0x1
 182:	e5250513          	addi	a0,a0,-430 # fd0 <thread_kill+0x66>
 186:	00001097          	auipc	ra,0x1
 18a:	874080e7          	jalr	-1932(ra) # 9fa <printf>
 18e:	44ad                	li	s1,11
 190:	00001a17          	auipc	s4,0x1
 194:	e40a0a13          	addi	s4,s4,-448 # fd0 <thread_kill+0x66>
        if (i == 17) {
 198:	49c5                	li	s3,17
 ...
 1a2:	d24080e7          	jalr	-732(ra) # ec2 <thread_yield>
        printf("thread 5: %d\n", i++);
 ...
 1be:	b1c080e7          	jalr	-1252(ra) # cd6 <thread_exit>
...
00000000000001c4 <f4>:
{
 ...
 212:	cb4080e7          	jalr	-844(ra) # ec2 <thread_yield>
        printf("thread 4: %d\n", i++);
 ...
 22e:	aac080e7          	jalr	-1364(ra) # cd6 <thread_exit>
...
0000000000000234 <f3>:
{
 ...
 258:	cfa080e7          	jalr	-774(ra) # f4e <thread_register_handler>
 ...
 290:	9f8080e7          	jalr	-1544(ra) # c84 <thread_add_runqueue>
    int i = 10000;
 294:	6589                	lui	a1,0x2
 296:	71058593          	addi	a1,a1,1808 # 2710 <__global_pointer$+0xec7>
        printf("thread 3: %d\n", i++);
 29a:	00001997          	auipc	s3,0x1
 29e:	d5698993          	addi	s3,s3,-682 # ff0 <thread_kill+0x86>
        if (i == 10003) {
 2a2:	6a89                	lui	s5,0x2
 2a4:	713a8913          	addi	s2,s5,1811 # 2713 <__global_pointer$+0xeca>
        if (i == 10004) {
 ...
 2ba:	cb4080e7          	jalr	-844(ra) # f6a <thread_kill>
        if (i == 10006) {
 ...
 2c8:	ca6080e7          	jalr	-858(ra) # f6a <thread_kill>
        if (i == 10006) {
 2cc:	a029                	j	2d6 <f3+0xa2>
            thread_exit();
 2ce:	00001097          	auipc	ra,0x1
 2d2:	a08080e7          	jalr	-1528(ra) # cd6 <thread_exit>
        thread_yield();
 2d6:	00001097          	auipc	ra,0x1
 2da:	bec080e7          	jalr	-1044(ra) # ec2 <thread_yield>
        printf("thread 3: %d\n", i++);
 2de:	85a6                	mv	a1,s1
...
void f1(void *arg)
{
 ...
 320:	c32080e7          	jalr	-974(ra) # f4e <thread_register_handler>
    int i = 100;
 ...
 364:	ca098993          	addi	s3,s3,-864 # 1000 <thread_kill+0x96>
        if (i == 101) {
 ...
 37e:	bf0080e7          	jalr	-1040(ra) # f6a <thread_kill>
        if (i == 105) {
 ...
 38c:	be2080e7          	jalr	-1054(ra) # f6a <thread_kill>
        if (i == 105) {
 390:	a029                	j	39a <f1+0x9e>
            thread_exit();
 392:	00001097          	auipc	ra,0x1
 396:	944080e7          	jalr	-1724(ra) # cd6 <thread_exit>
        }
        thread_yield();
 39a:	00001097          	auipc	ra,0x1
 39e:	b28080e7          	jalr	-1240(ra) # ec2 <thread_yield>
        printf("thread 1: %d\n", i++);
 3a2:	85a6                	mv	a1,s1
...
int main(int argc, char **argv)
{
 ...
 3cc:	c4850513          	addi	a0,a0,-952 # 1010 <thread_kill+0xa6>
 ...
 3f6:	b30080e7          	jalr	-1232(ra) # f22 <thread_start_threading>
    printf("\nexited\n");
 3fa:	00001517          	auipc	a0,0x1
 3fe:	c2650513          	addi	a0,a0,-986 # 1020 <thread_kill+0xb6>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 76a:	8d250513          	addi	a0,a0,-1838 # 1038 <digits>
 76e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 836:	806b8b93          	addi	s7,s7,-2042 # 1038 <digits>
 ...
 976:	6be90913          	addi	s2,s2,1726 # 1030 <thread_kill+0xc6>
        while(*s != 0){
...
free(void *ap)
{
 ...
 a3e:	6167b783          	ld	a5,1558(a5) # 1050 <freep>
 ...
 a6c:	00e6ea63          	bltu	a3,a4,a80 <free+0x50>
{
 ...
 aae:	5af73323          	sd	a5,1446(a4) # 1050 <freep>
}
 ab2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 ae0:	57453503          	ld	a0,1396(a0) # 1050 <freep>
 ...
 b08:	54c90913          	addi	s2,s2,1356 # 1050 <freep>
  if(p == (char*)-1)
 b0c:	5afd                	li	s5,-1
 b0e:	a88d                	j	b80 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 b10:	00000797          	auipc	a5,0x0
 b14:	55078793          	addi	a5,a5,1360 # 1060 <base>
 b18:	00000717          	auipc	a4,0x0
 b1c:	52f73c23          	sd	a5,1336(a4) # 1050 <freep>
 b20:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 b42:	50a73923          	sd	a0,1298(a4) # 1050 <freep>
      return (void*)(p + 1);
...
struct thread *thread_create(void (*f)(void *), void *arg){
 ...
 c4c:	40470713          	addi	a4,a4,1028 # 104c <id>
 c50:	431c                	lw	a5,0(a4)
 c52:	0af4a223          	sw	a5,164(s1)
    t->buf_set = 0;
 c56:	0a04a023          	sw	zero,160(s1)
 ...
 c66:	57fd                	li	a5,-1
 c68:	fcdc                	sd	a5,184(s1)
    t->sig_handler[1] = NULL_FUNC;
 c6a:	e0fc                	sd	a5,192(s1)
    t->signo = -1;
 c6c:	0cf4a423          	sw	a5,200(s1)
    t->handler_buf_set = 0;
 c70:	1404a023          	sw	zero,320(s1)
    return t;
}
 c74:	8526                	mv	a0,s1
...
void thread_add_runqueue(struct thread *t){
 ...
 c8e:	3ce7b783          	ld	a5,974(a5) # 1058 <current_thread>
 ...
 c94:	7fd8                	ld	a4,184(a5)
 c96:	fd58                	sd	a4,184(a0)
        t->sig_handler[1] = current_thread->sig_handler[1];
 c98:	63f8                	ld	a4,192(a5)
 c9a:	e178                	sd	a4,192(a0)
        current_thread->previous->next = t;
 c9c:	77d8                	ld	a4,168(a5)
 c9e:	fb48                	sd	a0,176(a4)
        t->previous = current_thread->previous;
 ca0:	77d8                	ld	a4,168(a5)
 ca2:	f558                	sd	a4,168(a0)
        current_thread->previous = t;
 ca4:	f7c8                	sd	a0,168(a5)
        t->next = current_thread;
 ca6:	f95c                	sd	a5,176(a0)
    }
    return;
}
 ca8:	6422                	ld	s0,8(sp)
 ...
 cb2:	3aa7b523          	sd	a0,938(a5) # 1058 <current_thread>
        t->previous = t;
 cb6:	f548                	sd	a0,168(a0)
        t->next = t;
 cb8:	f948                	sd	a0,176(a0)
...
void schedule(void){
 ...
 cc6:	39678793          	addi	a5,a5,918 # 1058 <current_thread>
 cca:	6398                	ld	a4,0(a5)
 ccc:	7b58                	ld	a4,176(a4)
 cce:	e398                	sd	a4,0(a5)
    return;
...
void thread_exit(void){
 ...
 ce4:	3787b783          	ld	a5,888(a5) # 1058 <current_thread>
 ce8:	7bd8                	ld	a4,176(a5)
 cea:	04e78c63          	beq	a5,a4,d42 <thread_exit+0x6c>
        // TODO
        
        current_thread->previous->next = current_thread->next;
 cee:	77d4                	ld	a3,168(a5)
 cf0:	fad8                	sd	a4,176(a3)
        current_thread->next->previous = current_thread->previous;
 cf2:	77d4                	ld	a3,168(a5)
 cf4:	f754                	sd	a3,168(a4)
        free(current_thread->stack);
 cf6:	6b88                	ld	a0,16(a5)
 cf8:	00000097          	auipc	ra,0x0
 cfc:	d38080e7          	jalr	-712(ra) # a30 <free>
        if(current_thread->handler_buf_set){
 d00:	00000797          	auipc	a5,0x0
 d04:	3587b783          	ld	a5,856(a5) # 1058 <current_thread>
 d08:	1407a703          	lw	a4,320(a5)
 d0c:	e70d                	bnez	a4,d36 <thread_exit+0x60>
            free(current_thread->stack_handler);
        }
        struct thread* t = current_thread;
 d0e:	00000797          	auipc	a5,0x0
 d12:	34a78793          	addi	a5,a5,842 # 1058 <current_thread>
 d16:	6388                	ld	a0,0(a5)
        current_thread = current_thread->next;
 d18:	7958                	ld	a4,176(a0)
 d1a:	e398                	sd	a4,0(a5)
        free(t);
 d1c:	00000097          	auipc	ra,0x0
 d20:	d14080e7          	jalr	-748(ra) # a30 <free>
        dispatch();
 d24:	00000097          	auipc	ra,0x0
 d28:	062080e7          	jalr	98(ra) # d86 <dispatch>
        free(current_thread);
        longjmp(env_st, 1);
 ...
 d34:	8082                	ret
            free(current_thread->stack_handler);
 d36:	7388                	ld	a0,32(a5)
 d38:	00000097          	auipc	ra,0x0
 d3c:	cf8080e7          	jalr	-776(ra) # a30 <free>
 d40:	b7f9                	j	d0e <thread_exit+0x38>
        if(current_thread->handler_buf_set){
 d42:	1407a703          	lw	a4,320(a5)
 d46:	eb15                	bnez	a4,d7a <thread_exit+0xa4>
        free(current_thread->stack);
 d48:	00000497          	auipc	s1,0x0
 d4c:	31048493          	addi	s1,s1,784 # 1058 <current_thread>
 d50:	609c                	ld	a5,0(s1)
 d52:	6b88                	ld	a0,16(a5)
 d54:	00000097          	auipc	ra,0x0
 d58:	cdc080e7          	jalr	-804(ra) # a30 <free>
        free(current_thread);
 d5c:	6088                	ld	a0,0(s1)
 d5e:	00000097          	auipc	ra,0x0
 d62:	cd2080e7          	jalr	-814(ra) # a30 <free>
        longjmp(env_st, 1);
 d66:	4585                	li	a1,1
 d68:	00000517          	auipc	a0,0x0
 d6c:	30850513          	addi	a0,a0,776 # 1070 <env_st>
 d70:	00000097          	auipc	ra,0x0
 d74:	e64080e7          	jalr	-412(ra) # bd4 <longjmp>
    return;
 d78:	bf55                	j	d2c <thread_exit+0x56>
            free(current_thread->stack_handler);
 d7a:	7388                	ld	a0,32(a5)
 d7c:	00000097          	auipc	ra,0x0
 d80:	cb4080e7          	jalr	-844(ra) # a30 <free>
 d84:	b7d1                	j	d48 <thread_exit+0x72>

0000000000000d86 <dispatch>:
void dispatch(void){
 d86:	1101                	addi	sp,sp,-32
 d88:	ec06                	sd	ra,24(sp)
 d8a:	e822                	sd	s0,16(sp)
 d8c:	e426                	sd	s1,8(sp)
 d8e:	e04a                	sd	s2,0(sp)
 d90:	1000                	addi	s0,sp,32
    if(current_thread->signo>=0){
 d92:	00000517          	auipc	a0,0x0
 d96:	2c653503          	ld	a0,710(a0) # 1058 <current_thread>
 d9a:	0c852783          	lw	a5,200(a0)
 d9e:	0607cb63          	bltz	a5,e14 <dispatch+0x8e>
        if(current_thread->handler_buf_set){
 da2:	14052703          	lw	a4,320(a0)
 da6:	eb4d                	bnez	a4,e58 <dispatch+0xd2>
            if(current_thread->sig_handler[current_thread->signo] == NULL_FUNC){
 da8:	07d9                	addi	a5,a5,22
 daa:	078e                	slli	a5,a5,0x3
 ...
 dc2:	6505                	lui	a0,0x1
 dc4:	80050513          	addi	a0,a0,-2048 # 800 <vprintf+0x12>
 ...
 dea:	c541                	beqz	a0,e72 <dispatch+0xec>
            current_thread->handler_buf_set = 1;
 dec:	00000497          	auipc	s1,0x0
 df0:	26c48493          	addi	s1,s1,620 # 1058 <current_thread>
 df4:	609c                	ld	a5,0(s1)
 df6:	4705                	li	a4,1
 df8:	14e7a023          	sw	a4,320(a5)
            current_thread->sig_handler[current_thread->signo](current_thread->signo);
 dfc:	0c87a503          	lw	a0,200(a5)
 e00:	01650713          	addi	a4,a0,22
 e04:	070e                	slli	a4,a4,0x3
 ...
 e0c:	609c                	ld	a5,0(s1)
 e0e:	577d                	li	a4,-1
 e10:	0ce7a423          	sw	a4,200(a5)
    if(current_thread->buf_set){
 e14:	00000517          	auipc	a0,0x0
 e18:	24453503          	ld	a0,580(a0) # 1058 <current_thread>
 e1c:	0a052783          	lw	a5,160(a0)
 e20:	eba5                	bnez	a5,e90 <dispatch+0x10a>
        if(setjmp(current_thread->env) == 0){
 e22:	03050513          	addi	a0,a0,48
 e26:	00000097          	auipc	ra,0x0
 e2a:	d76080e7          	jalr	-650(ra) # b9c <setjmp>
 e2e:	c92d                	beqz	a0,ea0 <dispatch+0x11a>
        current_thread->buf_set = 1;
 e30:	00000797          	auipc	a5,0x0
 e34:	2287b783          	ld	a5,552(a5) # 1058 <current_thread>
 e38:	4705                	li	a4,1
 e3a:	0ae7a023          	sw	a4,160(a5)
 ...
 e48:	e92080e7          	jalr	-366(ra) # cd6 <thread_exit>
}
 ...
 e58:	4585                	li	a1,1
 e5a:	0d050513          	addi	a0,a0,208
 e5e:	00000097          	auipc	ra,0x0
 e62:	d76080e7          	jalr	-650(ra) # bd4 <longjmp>
 e66:	b77d                	j	e14 <dispatch+0x8e>
                thread_exit();
 ...
 e8a:	d4e080e7          	jalr	-690(ra) # bd4 <longjmp>
 e8e:	bfb9                	j	dec <dispatch+0x66>
        longjmp(current_thread->env, 1);
 e90:	4585                	li	a1,1
 e92:	03050513          	addi	a0,a0,48
 e96:	00000097          	auipc	ra,0x0
 e9a:	d3e080e7          	jalr	-706(ra) # bd4 <longjmp>
 e9e:	b75d                	j	e44 <dispatch+0xbe>
            current_thread->env->sp = (unsigned long)current_thread->stack_p;
 ea0:	00000517          	auipc	a0,0x0
 ea4:	1b853503          	ld	a0,440(a0) # 1058 <current_thread>
 ea8:	6d1c                	ld	a5,24(a0)
 eaa:	ed5c                	sd	a5,152(a0)
            current_thread->buf_set = 1;
 eac:	4785                	li	a5,1
 eae:	0af52023          	sw	a5,160(a0)
            longjmp(current_thread->env, 1);
 eb2:	4585                	li	a1,1
 eb4:	03050513          	addi	a0,a0,48
 eb8:	00000097          	auipc	ra,0x0
 ebc:	d1c080e7          	jalr	-740(ra) # bd4 <longjmp>
 ec0:	bf85                	j	e30 <dispatch+0xaa>

0000000000000ec2 <thread_yield>:
void thread_yield(void){
 ...
 ece:	18e53503          	ld	a0,398(a0) # 1058 <current_thread>
 ed2:	0c852783          	lw	a5,200(a0)
 ed6:	0207c663          	bltz	a5,f02 <thread_yield+0x40>
        if(setjmp(current_thread->handler_env) == 0){
 eda:	0d050513          	addi	a0,a0,208
 ede:	00000097          	auipc	ra,0x0
 ee2:	cbe080e7          	jalr	-834(ra) # b9c <setjmp>
 ee6:	c509                	beqz	a0,ef0 <thread_yield+0x2e>
}
 ee8:	60a2                	ld	ra,8(sp)
 eea:	6402                	ld	s0,0(sp)
 ...
 ef4:	dcc080e7          	jalr	-564(ra) # cbc <schedule>
            dispatch();
 ef8:	00000097          	auipc	ra,0x0
 efc:	e8e080e7          	jalr	-370(ra) # d86 <dispatch>
 f00:	b7e5                	j	ee8 <thread_yield+0x26>
        if(setjmp(current_thread->env) == 0){
 f02:	03050513          	addi	a0,a0,48
 f06:	00000097          	auipc	ra,0x0
 f0a:	c96080e7          	jalr	-874(ra) # b9c <setjmp>
 f0e:	fd69                	bnez	a0,ee8 <thread_yield+0x26>
            schedule();
 f10:	00000097          	auipc	ra,0x0
 f14:	dac080e7          	jalr	-596(ra) # cbc <schedule>
            dispatch();
 f18:	00000097          	auipc	ra,0x0
 f1c:	e6e080e7          	jalr	-402(ra) # d86 <dispatch>
    return;
 f20:	b7e1                	j	ee8 <thread_yield+0x26>

0000000000000f22 <thread_start_threading>:

void thread_start_threading(void){
 f22:	1141                	addi	sp,sp,-16
 f24:	e406                	sd	ra,8(sp)
 f26:	e022                	sd	s0,0(sp)
 f28:	0800                	addi	s0,sp,16
    // TODO
    
    if(setjmp(env_st) == 0){
 f2a:	00000517          	auipc	a0,0x0
 f2e:	14650513          	addi	a0,a0,326 # 1070 <env_st>
 f32:	00000097          	auipc	ra,0x0
 f36:	c6a080e7          	jalr	-918(ra) # b9c <setjmp>
 f3a:	c509                	beqz	a0,f44 <thread_start_threading+0x22>
        dispatch();
    }
    return;
 ...
 f48:	e42080e7          	jalr	-446(ra) # d86 <dispatch>
    return;
 f4c:	bfc5                	j	f3c <thread_start_threading+0x1a>

0000000000000f4e <thread_register_handler>:

// part 2
void thread_register_handler(int signo, void (*handler)(int)){
 f4e:	1141                	addi	sp,sp,-16
 f50:	e422                	sd	s0,8(sp)
 f52:	0800                	addi	s0,sp,16
    // TODO
    current_thread->sig_handler[signo] = handler;
 f54:	0559                	addi	a0,a0,22
 f56:	050e                	slli	a0,a0,0x3
 f58:	00000797          	auipc	a5,0x0
 f5c:	1007b783          	ld	a5,256(a5) # 1058 <current_thread>
 f60:	953e                	add	a0,a0,a5
 f62:	e50c                	sd	a1,8(a0)
    return;
}
 f64:	6422                	ld	s0,8(sp)
